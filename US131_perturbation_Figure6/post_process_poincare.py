...
#data0 = np.load("data_perturbed_2p5e2A_co.npy", allow_pickle=True)
#data1 = np.load("data_perturbed_2p5e2A_counter.npy", allow_pickle=True)

#data0 = np.load("data_perturbed_5e2A_co.npy", allow_pickle=True)
#data1 = np.load("data_perturbed_5e2A_counter.npy", allow_pickle=True)

data0 = np.load("data_perturbed_1e3A_co.npy", allow_pickle=True)
data1 = np.load("data_perturbed_1e3A_counter.npy", allow_pickle=True)
...
#plt.savefig(f"US131_poincare_trace_section_{section_idx}_2p5e2A.svg")
#plt.savefig(f"US131_poincare_trace_section_{section_idx}_5e2A.svg")
plt.savefig(f"US131_poincare_trace_section_{section_idx}_1e3A.svg")
#plt.show()
