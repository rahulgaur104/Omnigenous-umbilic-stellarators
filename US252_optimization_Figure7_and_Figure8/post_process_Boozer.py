...
fname_path1 = (
    os.getcwd()
    #+ "/eq_optimized_high-res_m2_NFP5.h5"
    + "/eq_omni_m2_NFP5_14.h5"
)


eq_new0 = Equilibrium.load(fname_path0)
...
rho0 = 0.5
#rho0 = 0.2
fig, ax, Boozer_data0 = plot_boozer_surface(eq_new0, rho=rho0, fieldlines=5, return_data=True)
#plt.show()
plt.close()
